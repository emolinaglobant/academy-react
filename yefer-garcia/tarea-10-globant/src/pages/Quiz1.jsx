...
const Quiz1 = ({ puntos, setpuntos, vidas, setvidas }) => {
  const quiz = "¿Cual es la Pelicula?";
  const answer = "Hombre Araña";
        ...
        <section>
          <p className="lifes">
            ...
            <span className="items-game">
              {vidas} <i className="bi bi-heart-fill heart"></i>
            </span>
          </p>
        </section>
      </aside>
