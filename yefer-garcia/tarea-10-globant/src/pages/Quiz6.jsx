...
const Quiz6 = ({ puntos, setpuntos, vidas, setvidas }) => {
  const quiz = "¿Cual es la Pelicula?";
  const answer = "Libro de la Vida";
      ...
      <article className="quiz-box">
        ...
        <section className="container-box">
          <section onClick={() => responder(1)} className="box">
            <h3>A</h3>
            <p id="opcion1">Libro de la Vida</p>
          </section>
          <section className="box" onClick={() => responder(2)}>
            <h3>B</h3>
            <p id="opcion2">Cenicienta</p>
          </section>
